        ...
        <div class="container  margin-bottom-20">
                ...
                <div class="user-dash-right padding-10">
                    ...
                    <div class="dash-right-link">
                        <ul>
                            ...
                            <li class="active"><a href="<?= Url::to(['/site/profile-buy']) ?>"><i class="fa fa-shopping-bag"></i>خرید های من</a></li>
            ...
            <div class="col-sm-8 margin-right-10 bg-white circle-top-5 md-shadow-z-1">
                <div class="title-v1  ">
                    ...
                    <h1 class="padding-bottom-10 padding-top-10 font-lg" >خرید های من</h1>
                </div>
                <article class="padding-10">
                    <p>تعداد خرید هایی که انجام داده اید را با جزییات مشاهده نمایید.</p>
                    <?php
                    if ($sales) {
                        ?>
                        <table class="table">
                            ...
                            <td colspan="2" class="text-center">--&nbsp;محصولی خریداری نشده است&nbsp;--</td>
